...
describe("createDefaultToolRegistry", () => {
  it("creates a tool registry pre-populated with list_directory, read_file, search_files, and write_file tools", () => {
    ...
    expect(names).toEqual(["list_directory", "read_file", "search_files", "write_file"]);
  });
});
